...
var InjectedDEXONConnector = /** @class */ (function (_super) {
    __extends(InjectedDEXONConnector, _super);
    function InjectedDEXONConnector(args) {
        if (args === void 0) { args = {}; }
    ...
    InjectedDEXONConnector.prototype.onActivation = function () {
        return __awaiter(this, void 0, void 0, function () {
            var dexon, web3, legacyError, noWeb3Error;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dexon = window.dexon, web3 = window.web3;
                        if (!dexon) return [3 /*break*/, 2];
                        return [4 /*yield*/, dexon.enable().catch(function (error) {
                        ...
                        if (dexon.on) {
                            ...
                            this.runOnDeactivation.push(function () {
                                if (dexon.removeListener) {
                                    dexon.removeListener('networkChanged', _this.networkChangedHandler);
                                    dexon.removeListener('accountsChanged', _this.accountsChangedHandler);
                                }
                            });
                        }
                        if (dexon.isDekuSan) {
    ...
    InjectedDEXONConnector.prototype.getProvider = function () {
        return __awaiter(this, void 0, void 0, function () {
            var dexon;
            return __generator(this, function (_a) {
                dexon = window.dexon;
                return [2 /*return*/, dexon];
            });
        });
    };
    InjectedDEXONConnector.prototype.getAccount = function (provider) {
        return __awaiter(this, void 0, void 0, function () {
            var account, unlockRequiredError;
            return __generator(this, function (_a) {
                account = _super.prototype.getAccount.call(this, provider);
                if (account === null) {
                    unlockRequiredError = Error('DEXON account locked.');
    ...
    InjectedDEXONConnector.prototype.onDeactivation = function () {
        this.runOnDeactivation.forEach(function (runner) { return runner(); });
        this.runOnDeactivation = [];
    };
    // event handlers
    InjectedDEXONConnector.prototype.networkChangedHandler = function (networkId) {
    ...
    InjectedDEXONConnector.prototype.accountsChangedHandler = function (accounts) {
        if (!accounts[0]) {
    ...
    return InjectedDEXONConnector;
}(connector_1.ErrorCodeMixin(connector_1.default, InjectedConnectorErrorCodes)));
exports.default = InjectedDEXONConnector;
//# sourceMappingURL=injected_dexon.js.map